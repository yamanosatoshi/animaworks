...
function statusLabel(s: Channel["status"]): string {
  switch (s) {
    case "online":
      return "オンライン";
    case "busy":
...
function statusClasses(s: Channel["status"]): string {
  switch (s) {
    case "online":
...
function statusDot(s: Channel["status"]): string {
  switch (s) {
    case "online":
