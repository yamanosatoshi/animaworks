    ...
    items: [
      {
        ...
        content:
          "KONのトップページから「無料で始める」をクリックし、メールアドレスまたはGoogleアカウントで登録できます。登録後、確認メールが届きますのでリンクをクリックして有効化してください。",
      },
      {
        id: "a2",
    ...
    items: [
      {
        ...
        content:
          "すべてのデータはSSL/TLS暗号化された状態でKONのサーバーに安全に保存されます。データはいつでも設定 → プライバシー設定からエクスポートできます。",
      },
      {
        id: "u2",
        title: "スマートフォンからも使えますか？",
        content:
          "KONはモバイルブラウザに対応したレスポンシブデザインを採用しています。iOS/Androidのブラウザから快適にご利用いただけます。専用アプリは現在開発中です。",
      },
      {
        id: "u3",
