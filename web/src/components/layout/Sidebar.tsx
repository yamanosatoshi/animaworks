...
const mainNavItems: NavItem[] = [
  ...
  { href: "/chat", icon: <ChatIcon />, label: "チャット" },
  { href: "/characters", icon: <CharacterIcon />, label: "キャラクター" },
  { href: "/mypage", icon: <MypageIcon />, label: "マイページ" },
];
...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside
      className="flex h-screen w-16 shrink-0 flex-col items-center bg-sidebar-bg py-3 justify-between"
              ...
              <Link
                ...
                className={[
                  ...
                  active
                    ...
                    : "text-sidebar-text-muted hover:text-sidebar-text hover:bg-white/5",
                ].join(" ")}
              >
                {item.icon}
                <span className={[
