...
const navItems: NavItem[] = [
  ...
  { href: "/help", label: "ヘルプ / FAQ", icon: <HelpIcon /> },
...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside
      className="flex h-screen w-16 flex-col items-center bg-slate-900 py-5 gap-1"
      aria-label="サイドバーナビゲーション"
    >
      {/* Logo */}
      <div className="mb-6 flex h-9 w-9 items-center justify-center rounded-xl bg-violet-600">
        <span className="text-xs font-bold text-white tracking-wide">KON</span>
      </div>
